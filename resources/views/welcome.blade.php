    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <br><br>
                <a class="btn btn-secondary" href="/shopee/variasibaru" role="button">Variasi Baru</a>
                <br><br>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <br><br>
                <a class="btn btn-secondary" href="/tokopedia/dps/variasibaru" role="button">Variasi Baru</a>
                <br><br>
