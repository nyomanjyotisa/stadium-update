    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <h3>PRODUK BARU</h3>
            <form method="post" action="/tokopedia/dps/produk_baru" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <label>Informasi Media Shopee</label>
                <div class="form-group">
                    <input type="file" name="media_shopee" required="required">
                </div>
                <br><br><br>
