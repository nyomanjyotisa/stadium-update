    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <h3>VARIASI BARU</h3>
            <form method="post" action="/shopee/variasi_baru" enctype="multipart/form-data">
                {{ csrf_field() }}
                
                <label>Pilih file excel Qasir GYR</label>
                <div class="form-group">
                    <input type="file" name="qasir_gyr" required="required">
                </div>
                <br>
