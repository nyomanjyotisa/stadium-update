...
class ShopeeController extends Controller 
{
    ...
    public function update_stok(){
        ...
        foreach($arrayGyr[0] as $singleGyr){
            if(str_contains($singleGyr[4], 'off') || str_contains($singleGyr[4], 'Nama Variasi') || is_null($singleGyr[9]) || $singleGyr[8] == 0){
                continue;
            }
        ...
        foreach($arrayDps[0] as $singleDps){
            if(str_contains($singleDps[4], 'off') || str_contains($singleDps[4], 'Nama Variasi') || is_null($singleGyr[9]) || $singleGyr[8] == 0){
                continue;
            }
